...
template <typename FPTYPE, bool radial_only_, bool use_deterministic_algorithm_ = false, int shared_mem_block_size_>
...
void prod_virial_a_r_gpu(FPTYPE* virial,
  ...
  virial_deriv_wrt_neighbors<FPTYPE, radial_only_, true, 64>
      <<<block_grid, thread_grid, 64 * sizeof(FPTYPE)>>>(virial, atom_virial, net_deriv, in_deriv,
